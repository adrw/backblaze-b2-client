...
describe("BackblazeB2Client integration test", function () {
    it("testCredentials", function () { return __awaiter(void 0, void 0, void 0, function () {
        var applicationKeyId, applicationKey, bucketName, credentials, b2, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    b2 = BackblazeB2Client(credentials);
                    _a = expect;
                    return [4 /*yield*/, b2.testCredentials()];
                case 1:
